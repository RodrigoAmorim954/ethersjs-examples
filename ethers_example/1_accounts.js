...
const main = async () => {
    ...
    const balance2 = await provider.getBalance(account3)

    console.log(`The balance of account 1 is: ${ethers.utils.formatEther(balance1)}`)
    console.log(`The balance of account 1 is: ${ethers.utils.formatEther(balance2)}`)
}
